        ...
        if (localStorage.length > 0 && this.tokenData.remember_token !== null) {
            this.httpAuthService.loginByRememberMeToken(this.tokenData.remember_token)
                ...
                if (resp) {
                    ...
                    _this.getUserAndRoles(resp.api_token);
                }
            });
        }
        this.msgService.loginSuccessMessage.subscribe(function (token) {
            _this.getUserAndRoles(token);
        });
    };
    CurrentUserBlockComponent.prototype.getUserAndRoles = function (apiToken) {
        var _this = this;
        this.httpAuthService.user(apiToken).subscribe(function (user) { return _this.currentUser = user; });
        this.httpAuthService.roles(apiToken).subscribe(function (roles) {
...
var HeaderAuthBlockComponent = /** @class */ (function () {
    function HeaderAuthBlockComponent(msgService, httpAuthService, cookieService) {
        this.msgService = msgService;
        this.httpAuthService = httpAuthService;
        this.cookieService = cookieService;
    }
...
var InfoWindowComponent = /** @class */ (function () {
    function InfoWindowComponent(msgService) {
        this.msgService = msgService;
        this.pMessage = null;
        this.visible = false;
    }
    Object.defineProperty(InfoWindowComponent.prototype, "message", {
        get: function () {
    ...
    InfoWindowComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.msgService.infoWindowShow.subscribe(function (m) {
            _this.message = m;
            _this.visible = true;
        });
    };
    InfoWindowComponent.prototype.cancel = function () {
        this.visible = false;
    };
...
var OrderResponse = /** @class */ (function () {
    function OrderResponse(pOrders) {
        this.pOrders = pOrders;
    }
    Object.defineProperty(OrderResponse.prototype, "orders", {
        get: function () {
            return this.pOrders;
        },
        set: function (value) {
    ...
    OrderResponse.fromJson = function (jsonObj) {
        var arr = [];
        jsonObj.map(function (e) {
            arr.push(e.order);
        });
        return new OrderResponse(arr);
    };
    OrderResponse.ctorParameters = function () { return [
        { type: Array }
    ]; };
...
var SaleProduct = /** @class */ (function () {
    function SaleProduct(pId, pName, pPrice, pBrandId, pMeasure) {
        this.pId = pId;
        this.pName = pName;
        this.pPrice = pPrice;
        this.pBrandId = pBrandId;
    ...
    Object.defineProperty(SaleProduct.prototype, "id", {
        get: function () {
            return this.pId;
        },
        set: function (value) {
    ...
    Object.defineProperty(SaleProduct.prototype, "name", {
        get: function () {
            return this.pName;
        },
        set: function (value) {
    ...
    Object.defineProperty(SaleProduct.prototype, "price", {
        get: function () {
            return this.pPrice;
        },
        set: function (value) {
    ...
    Object.defineProperty(SaleProduct.prototype, "brandId", {
        get: function () {
            return this.pBrandId;
        },
        set: function (value) {
    ...
    Object.defineProperty(SaleProduct.prototype, "measure", {
        get: function () {
...
var SaleProductsResponse = /** @class */ (function () {
    function SaleProductsResponse(pData) {
        this.pData = pData;
    }
    Object.defineProperty(SaleProductsResponse.prototype, "data", {
        get: function () {
            return this.pData;
        },
        set: function (value) {
    ...
    SaleProductsResponse.fromJson = function (jsonObj) {
        return new SaleProductsResponse(jsonObj.map(function (e) { return _SaleProduct__WEBPACK_IMPORTED_MODULE_0__["SaleProduct"].fromJson(e); }));
    };
    SaleProductsResponse.ctorParameters = function () { return [
        { type: Array }
    ]; };
...
var AdminGuard = /** @class */ (function () {
    function AdminGuard(httpAuthService, msgService, pRouter) {
        this.httpAuthService = httpAuthService;
        this.msgService = msgService;
    ...
    AdminGuard.prototype.isAdmin = function () {
        return this.httpAuthService.isAdmin(this.token).subscribe(function (r) {
            return r;
        });
    };
    ...
    Object.defineProperty(AdminGuard.prototype, "token", {
        get: function () {
            return this.pToken;
        },
        set: function (value) {
...
var AuthGuardGuard = /** @class */ (function () {
    function AuthGuardGuard(httpAuthService, msgService, pRouter) {
        this.httpAuthService = httpAuthService;
        this.msgService = msgService;
        this.pRouter = pRouter;
    }
    ...
    Object.defineProperty(AuthGuardGuard.prototype, "token", {
        get: function () {
            return this.pToken;
        },
        set: function (value) {
    ...
    AuthGuardGuard.prototype.isAuth = function () {
        return this.httpAuthService.user(this.token).subscribe(function (u) {
            if (u) {
                return true;
            }
        });
...
var AdminObjComponent = /** @class */ (function () {
    ...
    AdminObjComponent.prototype.ngOnInit = function () {
        ...
        this.adminMsgService.objectHasChoosen.subscribe(function (obj) {
            ...
            _this.addChangeObjForm.controls.img.clear();
            _this.addChangeObjForm.controls.imgId.clear();
...
var AdminSaleProductComponent = /** @class */ (function () {
    function AdminSaleProductComponent(brandService, productsService, adminMessageService, saleService) {
        this.brandService = brandService;
        this.productsService = productsService;
        this.adminMessageService = adminMessageService;
    ...
    AdminSaleProductComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.whatHaveToDo = 'add';
        this.brandService.allBrands.subscribe(function (b) { return _this.brands = b; });
        this.updateProducts();
    ...
    Object.defineProperty(AdminSaleProductComponent.prototype, "products", {
        get: function () {
            return this.pProducts;
        },
        set: function (value) {
    ...
    Object.defineProperty(AdminSaleProductComponent.prototype, "whatHaveToDo", {
        get: function () {
            return this.pWhatHaveToDo;
        },
        set: function (value) {
    ...
    Object.defineProperty(AdminSaleProductComponent.prototype, "onSubmitResponse", {
        get: function () {
            return this.pOnSubmitResponse;
        },
        set: function (value) {
    ...
    Object.defineProperty(AdminSaleProductComponent.prototype, "brands", {
        get: function () {
            return this.pBrands;
        },
        set: function (value) {
    ...
    // Functions
    AdminSaleProductComponent.prototype.fillInProduct = function (product) {
        this.addChangeProductForm.patchValue({
            id: product.id,
            name: product.name,
            brands: product.brandId,
    ...
    AdminSaleProductComponent.prototype.onSubmit = function () {
        var _this = this;
        this.saleService.addSaleProduct(this.addChangeProductForm.value, this.whatHaveToDo).subscribe(function (resp) {
            _this.adminMessageService.newsCampaignAddedMessage(resp);
            _this.clearFields();
        });
    };
    AdminSaleProductComponent.prototype.updateProducts = function () {
        var _this = this;
        this.saleService.saleProductsForAdmin.subscribe(function (p) {
            _this.products = p;
        });
    };
    AdminSaleProductComponent.prototype.clearFieldsByBtn = function (e) {
        e.preventDefault();
        this.clearFields();
    };
    AdminSaleProductComponent.prototype.clearFields = function () {
        this.addChangeProductForm.patchValue({
            id: '',
            name: '',
            brands: '',
    ...
    AdminSaleProductComponent.ctorParameters = function () { return [
        { type: _services_http_brands_brands_service__WEBPACK_IMPORTED_MODULE_2__["BrandsService"] },
        { type: _services_http_products_products_service__WEBPACK_IMPORTED_MODULE_6__["ProductsService"] },
    ...
    return AdminSaleProductComponent;
}());
...
var BuildingNavComponent = /** @class */ (function () {
    function BuildingNavComponent(authService, msgService) {
        this.authService = authService;
        this.msgService = msgService;
        this.pUser = false;
    }
    Object.defineProperty(BuildingNavComponent.prototype, "user", {
        get: function () {
            return this.pUser;
        },
        set: function (value) {
    ...
    BuildingNavComponent.prototype.getUser = function () {
        var _this = this;
        if (localStorage.length > 0) {
            var data = JSON.parse(localStorage.getItem('tokenData'));
    ...
    BuildingNavComponent.ctorParameters = function () { return [
        { type: _services_http_http_auth_service__WEBPACK_IMPORTED_MODULE_2__["HttpAuthService"], decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_services_http_http_auth_service__WEBPACK_IMPORTED_MODULE_2__["HttpAuthService"],] }] },
        { type: _services_messages_service__WEBPACK_IMPORTED_MODULE_3__["MessagesService"] }
    ]; };
...
var BuildTechInfoGroutCalcComponent = /** @class */ (function () {
    ...
    BuildTechInfoGroutCalcComponent.prototype.getResult = function (rate) {
        var width = parseInt(this.groutCalc.get('width').value, 10);
        var height = parseInt(this.groutCalc.get('height').value, 10);
        var thickness = parseInt(this.groutCalc.get('thickness').value, 10);
        var seam = parseInt(this.groutCalc.get('seam').value, 10);
        var square = parseInt(this.groutCalc.get('square').value, 10);
...
var OrderUnit = /** @class */ (function () {
    function OrderUnit(pBrandId, pBrand, pProductId, pProductName, pPrice, pQty, pAmount) {
        this.pBrandId = pBrandId;
        this.pBrand = pBrand;
    ...
    Object.defineProperty(OrderUnit.prototype, "brandId", {
        get: function () {
            return this.pBrandId;
        },
        set: function (value) {
    ...
    Object.defineProperty(OrderUnit.prototype, "brand", {
        get: function () {
            return this.pBrand;
        },
        set: function (value) {
    ...
    Object.defineProperty(OrderUnit.prototype, "productId", {
        get: function () {
    ...
    Object.defineProperty(OrderUnit.prototype, "productName", {
        get: function () {
    ...
    Object.defineProperty(OrderUnit.prototype, "price", {
        get: function () {
            return this.pPrice;
        },
        set: function (value) {
    ...
    Object.defineProperty(OrderUnit.prototype, "qty", {
        get: function () {
            return this.pQty;
        },
        set: function (value) {
    ...
    Object.defineProperty(OrderUnit.prototype, "amount", {
        get: function () {
            return this.pAmount;
        },
        set: function (value) {
    ...
    OrderUnit.ctorParameters = function () { return [
        { type: Number },
        { type: String },
        { type: Number },
        { type: String },
...
var OrderComponent = /** @class */ (function () {
    function OrderComponent(brandService, saleService, authService, msgService) {
        this.brandService = brandService;
        this.saleService = saleService;
        this.authService = authService;
        this.msgService = msgService;
    ...
    OrderComponent.prototype.ngOnInit = function () {
        ...
        this.getUser();
        this.sumAmount = 0;
        this.brandService.allBrands.subscribe(function (b) {
            _this.brands = b;
        });
        this.orderForm.get('brands').valueChanges.subscribe(function (value) {
            _this.saleService.saleProductsByBrand(_this.brands[value - 1].id).subscribe(function (p) {
                _this.products = null;
                _this.products = p;
        ...
        this.orderForm.get('productId').valueChanges.subscribe(function (value) {
            _this.products.forEach(function (e) {
                if (e.id == value) {
                    _this.currentProduct = e;
                    _this.orderForm.patchValue({
                        productName: _this.currentProduct.name,
                        productId: _this.currentProduct.id,
                        price: _this.currentProduct.price
                    }, { emitEvent: false });
                }
            });
        });
    };
    Object.defineProperty(OrderComponent.prototype, "user", {
        get: function () {
            return this.pUser;
        },
        set: function (value) {
    ...
    Object.defineProperty(OrderComponent.prototype, "orderPosition", {
        get: function () {
    ...
    Object.defineProperty(OrderComponent.prototype, "sumAmount", {
        get: function () {
    ...
    Object.defineProperty(OrderComponent.prototype, "products", {
        get: function () {
            return this.pProducts;
        },
        set: function (value) {
    ...
    Object.defineProperty(OrderComponent.prototype, "brands", {
        get: function () {
            return this.pBrands;
        },
        set: function (value) {
    ...
    Object.defineProperty(OrderComponent.prototype, "currentProduct", {
        get: function () {
            return this.pCurrentProduct;
        },
        set: function (value) {
    ...
    OrderComponent.prototype.getUser = function () {
        var _this = this;
        if (localStorage.length > 0) {
            var data = JSON.parse(localStorage.getItem('tokenData'));
            this.authService.user(data.api_token)
    ...
    OrderComponent.prototype.changeOrderItem = function (i) {
        ...
        this.order.map(function (e) {
            if (e.productId === i) {
                ...
                _this.saleService.saleProductsByBrand(e.brandId).subscribe(function (p) { return _this.products = p; });
            }
        });
    };
    OrderComponent.prototype.delOrderPos = function (i) {
        this.order.splice(i, 1);
    };
    OrderComponent.prototype.updateOrder = function (event) {
        var _this = this;
        event.preventDefault();
        this.order.map(function (e) {
            if (e.productId === _this.orderPosition) {
                var a = parseInt(_this.orderForm.value.qty, 10) * parseInt(_this.orderForm.value.price, 10);
                _this.orderForm.patchValue({ amount: a.toString() });
                e.brandId = parseInt(_this.orderForm.value.brands, 10),
                    e.brand = _this.brands[_this.orderForm.value.brands - 1].name,
                    e.productId = parseInt(_this.orderForm.value.productId, 10),
                    e.productName = _this.orderForm.value.productName,
                    e.price = _this.orderForm.value.price,
                    e.qty = _this.orderForm.value.qty,
                    e.amount = parseInt(_this.orderForm.value.amount, 10);
            }
        });
        this.sumAmount = this.order.reduce(function (sum, current) { return sum + current.amount; }, 0);
    };
    OrderComponent.prototype.sendByEmail = function (event) {
        var _this = this;
        event.preventDefault();
        this.checkUser();
        var strOrder = this.convertOrderToStr();
        this.saleService.sendOrderByEmail(strOrder, this.user.id, this.sumAmount)
            .subscribe(function (resp) {
            if (resp === 'email send') {
                var message = 'Уважаемый ' + _this.user.name + ', Ваш заказ отправлен на вашу почту. Наш менеджер свяжется с вами, для подтверждения заказа.';
                _this.msgService.infoWindowShowMessage(message);
            }
        });
    };
    OrderComponent.prototype.saveOrder = function (event) {
        var _this = this;
        this.checkUser();
        event.preventDefault();
        var strOrder = this.convertOrderToStr();
        this.saleService.saveOrder(strOrder, this.user.id)
            .subscribe(function (resp) {
            if (resp === 'insert success') {
                var message = 'Уважаемый ' + _this.user.name + ', Ваш заказ успешно сохранен. Для просмотра своих заказов, зайдите в Профиль->Заказы';
                _this.msgService.infoWindowShowMessage(message);
            }
        });
    };
    OrderComponent.prototype.checkUser = function () {
        if (!this.user) {
            this.getUser();
        }
    };
    OrderComponent.prototype.convertOrderToStr = function () {
        var strOrder = [];
...
var ApplyingGroupsService = /** @class */ (function () {
    ...
    ApplyingGroupsService.prototype.getApiToken = function () {
        if (localStorage.length > 0) {
            var data = JSON.parse(localStorage.getItem('tokenData'));
...
var BrandsService = /** @class */ (function () {
    ...
    BrandsService.prototype.getApiToken = function () {
        if (localStorage.length > 0) {
            var data = JSON.parse(localStorage.getItem('tokenData'));
            return data.api_token;
        }
...
var BuildingObjectsService = /** @class */ (function () {
    ...
    BuildingObjectsService.prototype.getApiToken = function () {
        if (localStorage.length > 0) {
            var data = JSON.parse(localStorage.getItem('tokenData'));
            return data.api_token;
        }
...
var CampaignService = /** @class */ (function () {
    ...
    CampaignService.prototype.getApiToken = function () {
        if (localStorage.length > 0) {
            var data = JSON.parse(localStorage.getItem('tokenData'));
            return data.api_token;
        }
...
var ClientsService = /** @class */ (function () {
    ...
    ClientsService.prototype.getApiToken = function () {
        if (localStorage.length > 0) {
            var data = JSON.parse(localStorage.getItem('tokenData'));
            return data.api_token;
        }
...
var HttpNewsService = /** @class */ (function () {
    ...
    HttpNewsService.prototype.getApiToken = function () {
        if (localStorage.length > 0) {
            var data = JSON.parse(localStorage.getItem('tokenData'));
            return data.api_token;
        }
...
var ProductsService = /** @class */ (function () {
    ...
    ProductsService.prototype.getApiToken = function () {
        if (localStorage.length > 0) {
            var data = JSON.parse(localStorage.getItem('tokenData'));
            return data.api_token;
        }
...
var SaleService = /** @class */ (function () {
    ...
    Object.defineProperty(SaleService.prototype, "saleProducts", {
        get: function () {
            return this.http.get(this.urlConfig.SHOW_SALES_PRODUCTS)
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (resp) { return _dto_sale_products_SaleProductsResponse__WEBPACK_IMPORTED_MODULE_5__["SaleProductsResponse"].fromJson(resp); }))
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (spr) { return spr.data; }));
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(SaleService.prototype, "saleProductsForAdmin", {
        get: function () {
    ...
    SaleService.prototype.saleProductsByBrand = function (brandId) {
        return this.http.get(this.urlConfig.SHOW_SALES_PRODUCT_BY_BRAND + brandId)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (resp) { return _dto_sale_products_SaleProductsResponse__WEBPACK_IMPORTED_MODULE_5__["SaleProductsResponse"].fromJson(resp); }))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (spr) { return spr.data; }));
    };
    SaleService.prototype.sendOrderByEmail = function (order, userId, amount) {
        var params = new FormData();
    ...
    SaleService.prototype.saveOrder = function (order, userId) {
        var date = Date.now();
        var params = new FormData();
        params.append('id', '');
        params.append('order', order);
    ...
    SaleService.prototype.getApiToken = function () {
        if (localStorage.length > 0) {
            var data = JSON.parse(localStorage.getItem('tokenData'));
            return data.api_token;
        }
    ...
    SaleService.prototype.addSaleProduct = function (data, action) {
        var params = new FormData();
        params.append('api_token', this.getApiToken());
        params.append('action', action);
        params.append('id', data.id);
    ...
    SaleService.prototype.showOrders = function (userId) {
        var params = new FormData();
        params.append('api_token', this.getApiToken());
...
var SolutionsService = /** @class */ (function () {
    ...
    SolutionsService.prototype.getApiToken = function () {
        if (localStorage.length > 0) {
            var data = JSON.parse(localStorage.getItem('tokenData'));
            return data.api_token;
        }
...
var MessagesService = /** @class */ (function () {
    ...
    Object.defineProperty(MessagesService.prototype, "infoWindowShow", {
        get: function () {
    ...
    MessagesService.prototype.infoWindowShowMessage = function (message) {
